...
This section further discusses the generals\todo{is this proper English?} of symmetric-key, public-key and related topics.
...
The domain parameters $a,b\in\mathbb{F}_q$ describe the curve $E$ as $y^2=x^3+ax+b$. For \todo[inline]{continue here}.
