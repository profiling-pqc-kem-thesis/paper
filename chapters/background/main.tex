...
The elliptic-curve-based \gls{x25519} is used for key exchange in the \gls{vpn} Wireguard~\cite{wireguard2020}. In some contexts, the \gls{x25519} algorithm is known as \gls{curve25519}~\cite{25519naming}.
