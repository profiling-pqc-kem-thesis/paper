...
\begin{table}
    ...
    \begin{tabularx}{\linewidth}{X c c c c}
        ...
        & & & \thead{Keypair} & \thead{Exchange} \\
        \midrule
        IBM Community Cloud & \gls{p-256} & 1.1.1g FIPS & 12184 & 0 \\
        IBM Community Cloud & \gls{curve25519} & 1.1.1g FIPS & 4524 & 1024 \\
...
The \gls{ecdhe} implementation behaved much like the \gls{dhe}, with the peaks differing between some environments. The implementation too worked with OpenSSL's arbitrary numbers and as such had several of the same allocations as the \gls{dhe} implementations. The peaks are presented in Table \ref{table:results:memory:ecdhe-heap}. Though it is unclear why the exchange stage is sometimes zero, it could be due to OpenSSL's internal handling of memory.
