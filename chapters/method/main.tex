...
A non-sampling-based tool that monitors the entire lifetime of a process is Valgrind and its sub-tool Callgrind. The tool was found to not support running all of our samples on all targeted environments. It was therefore deemed inappropriate for use as the main instrumentation tool.
