...
The cloud hardware was chosen to represent various cloud providers' Virtual Private Server offerings - a common target for many applications\todo{cite}. The offerings are all virtual CPUs which run through hypervisors in a shared hosting environment.

The selected mainframe hardware is intended to represent the latest mainframes available from IBM at the time of writing.\todo{needs rewrite}
...
\begin{table}[H]
    ...
    \begin{tabularx}{\linewidth}{X c c c}
        ...
        \thead{Label} & \thead{CPU} & \thead{RAM} & \thead{OS}\\
        \midrule
        Cloud Provider 1\footnotemark & Intel Xeon Platinum 8168, 4 vCPU & 4GB & Ubuntu 18.04\footnotemark\\
        Cloud Provider 2\footnotemark & Intel Xeon Gold 5118\footnotemark,  vCPU & 4GB & Ubuntu 20.04\\
        \bottomrule
    \end{tabularx}
\end{table}
...
\begin{table}[H]
    ...
    \begin{tabularx}{\linewidth}{X c c c c}
        ...
        \midrule
        Mainframe\footnotemark & IBM T01 & IBM \gls{z15} 2 cores\footnotemark & 4GB & RHEL 8.3\footnotemark\\
        \bottomrule
    \end{tabularx}
\end{table}
...
\begin{table}[H]
    ...
    \begin{tabularx}{\linewidth}{l c c X}
        ...
        IBM XL Optimized & IBM XL & -march=native -mtune=native -O3\\
        \bottomrule
    \end{tabularx}
\end{table}
