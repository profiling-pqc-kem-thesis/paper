...
\todo[inline]{Taskigt att mäta avx på intel, men inget vektoriserat på IBM}
...
\todo[inline]{
we did not get OpenSSL working on IBM, which could have altered the results for ecdh, dh.
Not an issue as we got great performance anyway?
}
...
\todo[inline]{
Rewrite as past tense
}

\todo[inline]{
Alla andra stänger av turbo och hyperthreads, vi gjorde det inte
}

\todo[inline]{Measurement issues with perf - overflow or negative numbers in uint64}
