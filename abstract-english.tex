...
\todo[inline]{
Refer to tables: "As can be seen in Table 1" <- capital letter
Mellanrum innan reference -> "bla bla [1]."
}

\todo[inline]{
Referera första stycket i en mening. Antas sedan återanvändas genom stycket. Nytt stycke, ny referering. Ny källa, nytt referat.
}

\todo[inline]{
Använd IBM Z som forskningsfråga / utgångspunkt, rubrik i bakgrund. etc. Scope:a sedan ned till z15?
}
...
\todo[inline]{
Kolla igenom alla glossaries - om de används, om de är korrekta o.s.v.
}

\todo[inline]{
Fix \noindent in applicable places.
}
